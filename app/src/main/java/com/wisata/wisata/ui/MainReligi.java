...
public class MainReligi extends AppCompatActivity {
    ...
    class AmbilData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(MainReligi.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(config.url_tour_religi,
                    "GET", params);
